...
public class HoChiMinhSink {
    private static KafkaConsumer<String, String> consumer;
    private static final String HOCHIMINH_SINK_TOPIC = "hochiminh-sink";
    public static void main(String[] args) {
        Properties consumerProperties = new Properties();
        consumerProperties.setProperty(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
        consumerProperties.setProperty(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer .class.getName());
        consumerProperties.setProperty(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getName());
        consumerProperties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "hochiminh-sink-group");
        ...
        try {
            consumer.subscribe(Collections.singleton(HOCHIMINH_SINK_TOPIC));
            while (true) {
